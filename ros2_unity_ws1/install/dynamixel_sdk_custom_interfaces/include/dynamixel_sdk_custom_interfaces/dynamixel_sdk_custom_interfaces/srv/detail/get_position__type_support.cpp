...
{
  new (message_memory) dynamixel_sdk_custom_interfaces::srv::GetPosition_Request(_init);
}

void GetPosition_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::srv::GetPosition_Request *>(message_memory);
...
void GetPosition_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) dynamixel_sdk_custom_interfaces::srv::GetPosition_Response(_init);
}

void GetPosition_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::srv::GetPosition_Response *>(message_memory);
